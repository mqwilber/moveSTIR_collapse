...
# create an array with the presence of each individual in each cell for each time step. THis will be used to calculate the correlation.
expand.grid()
```
...
for (i in unique(sim_tracks_db$ind)) {
  lines(sim_tracks_db[sim_tracks_db$ind == i, ], col = hcl.colors(6, palette = "Set 2")[i])
}
