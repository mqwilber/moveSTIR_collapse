...
%We simulate three types of interaction. 
...
Correlation in movement is 1 at lag 0 (because hosts are together constantly) and decreases to approximately -1 by time $\eta$ before increasing close to 1 by time $2\eta$, etc. % JUAN here: I'm not getting the same results for the example below. Corr starts at 1, yes, but does not go to -1, the "sawtooth" pattern dampens
