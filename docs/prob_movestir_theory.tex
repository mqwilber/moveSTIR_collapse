...
% JUAN: Yes, most correlation values are just noise. We can remove them just by using a standard threshold. There is still an issue that I think is due to the number of visits per cell. In cases where you get a single encounter, there will be a correlation of 1, which is deemed significant. This value 
