...
% Concluding remarks
% [Could drop] Individual movement and spatio-temporal overlap are recognized as critical drivers for the transmission of infectious diseases. We have shown that correlation and synchronicity can have a significant, yet often ignored, impact on transmission dynamics.  We have developed an epidemiologically-grounded model that explicitly accounts for spatial factors, social processes, and parasite life history to estimate landscape-wide risk of pairwise transmission from commonly available movement data.  Our approach is flexible and should be readily applicable to many terrestrial host-parasite systems. Importantly, we expect that our spatially explicit, probabilistic framing will facilitate direct links between transmission risk and underlying environmental factors driving movement, contact, parasite development, and survival.  Ultimately, PMoveSTIR can help us build epidemiological landscapes informed by empirical movement data that can help predict and manage where diseases will invade, spread, and persist on real-world landscapes.
...
% Predicting epidemiological landscapes from host movements relies on the key assumption that environmental characteristics strongly influence movement and space use. While there is a growing number of methods that quantify the effect of environmental characteristics on movement and habitat use \citep{Hooten2017a}, there has been much less work exploring how (and if) environment affects correlation and synchrony among hosts [but see citations]. 
...
% Concluding remarks
% Individual movement and spatio-temporal overlap are recognized as critical drivers for the transmission of infectious diseases. In addition, we have shown that correlation and synchronicity can have a significant, yet often ignored, impact on transmission dynamics.  We have developed an epidemiologically-grounded model that explicitly accounts for spatial factors, social processes, and parasite life history to estimate landscape-wide risk of pairwise transmission from commonly available movement data.  Our approach is flexible and should be readily applicable to many terrestrial host-parasite systems. Importantly, we expect that our spatially explicit, probabilistic framing will facilitate direct links between transmission risk and underlying environmental factors driving movement, contact, parasite development, and survival.  Ultimately, PMoveSTIR can help us build epidemiological landscapes informed by empirical movement data that can help predict and manage where diseases will invade, spread, and persist on real-world landscapes.
