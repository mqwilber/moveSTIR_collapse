...
% Despite correlated host movements having largely been ignored in contact and disease ecology, our model clearly illustrates that there are relevant epidemiological conditions where among host correlation can be the dominate mechanism shaping spatio-temporal contact transmission dynamics, as opposed to resource selection, habitat use, and utilization distributions more generally.  

% This result has important implications for predicting           spatio-temporal transmission risk. Importantly, PMoveSTIR provides theoretical rationale for why observed patterns of transmission have fine-scale spatial signatures beyond patterns of resource selection, spatial overlap, and habitat use \citep[e.g.,][]{Albery2021,Yang2023a}. Moreover, 
...
% PMoveSTIR is explicitly defined in epidemiological terms, emphasizing processes with temporal dynamics relevant for transmission, such as contact---direct and indirect---among individuals, parasite shedding and survival in the environment, and, importantly, correlation in space use. 
